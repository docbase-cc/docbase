...
import type { DeleteV0PluginData, DeleteV0PluginResponse, GetV0PluginData, GetV0PluginResponse, PutV0PluginData, PutV0PluginResponse, GetV0PluginExtData, GetV0PluginExtResponse, PatchV0PluginExtData, PatchV0PluginExtResponse, PostV0DifyRetrievalData, PostV0DifyRetrievalResponse, PostV0DifyRetrievalError, PostV0BaseKnowledgeIdSearchData, PostV0BaseKnowledgeIdSearchResponse, PostV0BaseKnowledgeIdSearchError, DeleteV0BaseBaseData, DeleteV0BaseBaseResponse, GetV0BaseBaseData, GetV0BaseBaseResponse, PutV0BaseBaseData, PutV0BaseBaseResponse, DeleteV0BaseKnowledgeIdEmbedderData, DeleteV0BaseKnowledgeIdEmbedderResponse, GetV0BaseKnowledgeIdEmbedderData, GetV0BaseKnowledgeIdEmbedderResponse, PostV0BaseKnowledgeIdEmbedderData, PostV0BaseKnowledgeIdEmbedderResponse, GetSystemData, GetSystemResponse, PostSystemData, PostSystemResponse, PostSystemError } from './types.gen';
 ...
 * del knowledge base
 */
export const deleteV0BaseBase = <ThrowOnError extends boolean = false>(options?: Options<DeleteV0BaseBaseData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteV0BaseBaseResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * get knowledge bases
 */
export const getV0BaseBase = <ThrowOnError extends boolean = false>(options?: Options<GetV0BaseBaseData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetV0BaseBaseResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * add knowledge base
 */
export const putV0BaseBase = <ThrowOnError extends boolean = false>(options?: Options<PutV0BaseBaseData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).put<PutV0BaseBaseResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
